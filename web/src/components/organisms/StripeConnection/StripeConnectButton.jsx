...
const StripeConnectButton = ({ clientId }) => {
  const { t } = useTranslation();
  const qs = queryString.stringify({
    response_type: 'code',
    client_id: clientId,
    scope: 'read_write',
    redirect_uri: `${window.location.origin}/my-profile/payments`,
  });
  return (
    <StyledA href={`https://connect.stripe.com/oauth/authorize?${qs}`}>
      <span>{t('myProfilePage.payments.connectWithStripe')}</span>
    </StyledA>
  );
};
